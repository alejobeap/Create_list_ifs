...
output_txt = "Longs_combination_average_cc.txt"
output_txt_std = "Longs_comination_average_cc.txt"
        ...
        with open(volcanoes_file, "r", encoding="utf-8") as vf:
            ...
            for line in vf:
                ...
                if line.startswith('"'):
                    ...
                    if len(rest) != 3:
                        print(f"LÃ­nea con formato inesperado: {line}")
                        continue
    ...
    try:
        ...
        with rasterio.open(hgt_path) as src:
            ...
            max_lat = lat + buffer_deg
                        ...
                        # Leer toda la banda 1 (elevaciIÂ³n completa)
...
def main():
    ...
    if len(sys.argv) < 2:
        print(f"No se ingresÃ³ el nombre del volcÃ¡n por lÃ­nea de comando.")
        volcano_name = get_volcano_name_from_file(name_file)
        if not volcano_name:
            print(f"No se encontrÃ³ el archivo {name_file} o estÃ¡ vacÃ­o. Usando valor por defecto: {default_volcano_name}")
    ...
    if not volcano_info:
        ...
        print(f"InformaciÃ³n del volcÃ¡n: {volcano_info}")
