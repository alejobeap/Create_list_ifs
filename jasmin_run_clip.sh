...
./batch_LiCSBAS_clip.sh
LiCSBAS_flt2geotiff.py -i TS_GEOCml2maskclip/results/vel.filt.mskd -p GEOCml2maskclip/EQA.dem_par -o ${parent_dir}_${current_dir}_clip.vel_filt.mskd.geo.tif
...
LiCSBAS_disp_img.py -i TS_GEOCml2maskclip/results/vel.filt.mskd -p GEOCml2maskclip/EQA.dem_par -c SCM.roma_r --cmin -20 --cmax 20 --kmz ${parent_dir}_${current_dir}_clip.vel.mskd.kmz
